...
<script type="text/javascript" src="resources/js/userOrderDetailsUtil.js" defer></script>
...
<div class="container">
    <div class="jumbotron">
        <div class="shadow">
            ...
            <div class="view-box">
            <c:choose>
                <c:when test="${orderStatus=='ACCEPTED'}">
                    ...
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${orderStatus=='ACCEPTED'}">
                                ...
                                <th class="col-xs-1"><fmt:message key="common.sum"/></th>
                                <th><fmt:message key="common.delete"/></th>

                            </c:when>
                            <c:otherwise>
                                <th class="collapse" ><span class="glyphicon glyphicon-plus"></span></th>
                                <th class="col-xs-1"><fmt:message key="common.quantity"/></th>
                                <th class="collapse"><span class="glyphicon glyphicon-minus"></span></th>
                                <th class="col-xs-1"><fmt:message key="common.sum"/></th>
                                <th class="collapse"><fmt:message key="common.delete"/></th>
                ...
                <table class="table" >
                    <tr>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <th class="col-sm-1" style="text-align: center">
                                    <a class="btn btn-primary" type="button" onclick="history.back()">
                                        <span class="glyphicon glyphicon-ok"></span>
...
<%--send orderStatus to JS to manage datable's columns--%>
